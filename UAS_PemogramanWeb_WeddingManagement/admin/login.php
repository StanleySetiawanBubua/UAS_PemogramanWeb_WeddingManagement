     ...
     if($logged) {
         ...
         $session->message("
            <div class=\"alert alert-danger alert-dismissible fade show\" role=\"alert\">
              <strong><i class='mdi mdi-alert'></i></strong>  Email dan password tidak selaras. Coba lagi.
...
<form class="form-signin" action="" method="post">
    ...
    <h5 class="h5 mb-3 font-weight-normal" style="color:#222">Login Sebagai Admin</h5>
    <?php
        if ($session->message()) {
