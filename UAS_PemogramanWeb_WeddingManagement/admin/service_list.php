...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
    <h4 class="h4 mt-4 ml-3">Layanan dan Paket</h4>
     <div class="btn-toolbar mb-2 mb-md-0">
        <div class="btn-group mr-2">
            <a class="btn btn-md btn-success mr-2" style="font-size: 12px;" href="package_add.php"><i class="mdi mdi-buffer mr-2"></i> Tambah Paket</a>
        </div>
    </div>
</div>
            ...
            <table id="example" class="table table-striped table-hover table-bordered table-sm" cellspacing="0" width="100%" style="background: white;padding: 5px">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="special">Rp. <b><?= number_format($category_row->price, 0, ',', '.'); ?> juta</b></td>
                        <td>
        ...
        <div class="col-md-12 mt-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
                <h4 class="h4 mt-4 ml-3">Wedding Features</h4>
                 <div class="btn-toolbar mb-2 mb-md-0">
                    <div class="btn-group mr-2">
                        <a class="btn btn-md btn-success mr-2" style="font-size: 12px;" href="feature_add.php"><i class="mdi mdi-clipboard-outline mr-2"></i> Tambah Fitur</a>
                    </div>
                </div>
            </div>
