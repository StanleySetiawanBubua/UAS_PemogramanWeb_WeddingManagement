    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-8 offset-2 pl-3 pb-3 box-shadow mt-4 pt-3">
                <h5>Unggah Gambar Baru</h5>
                <?= (isset($msg) ? $msg : ''); ?>
                <form method="post" action="" enctype="multipart/form-data">

                    <div class="form-group">
                        <label for="booking_id">Relasi:</label>
                   ...
                   <div class="form-group">
                       ...
                       <input type="text" name="caption" value="<?= $gallery->caption; ?>" class="form-control" placeholder="Keterangan">
                   </div>
                    <div class="form-group">
                       <label for="">Teks Alternatif:</label>
                       <input type="text" name="alternate_text" value="<?= $gallery->alternate_text; ?>" class="form-control" placeholder="Teks Alternatif">
                   </div>
                   <div class="form-group">
                       <textarea name="description" rows="10" class="form-control" placeholder="Deskripsi"><?= $gallery->description; ?></textarea>
                   </div>
                   <div class="form-group">
                       <input type="file" name="file">
                   </div>
                   <button type="submit" name="submit" value="" class="btn btn-success btn-sm">Simpan Gambar</button>
                   <a href="photos_view.php" class="btn btn-danger btn-sm">Kembali</a>
                </form><!-- end of input form -->
<br>
                <h5 class="h5">Atau Seret Gambar</h5>
