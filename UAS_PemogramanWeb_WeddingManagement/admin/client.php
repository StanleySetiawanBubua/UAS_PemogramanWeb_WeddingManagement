...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
    <h6 class="h4 mt-4 ml-3">Belum Konfirmasi</h6>
    <div class="btn-toolbar mb-md-0">
        <div class="btn-group mr-2">
            <a class="btn btn-md btn-success" style="font-size: 12px;" href="client_add.php"><i class="mdi mdi-account-plus mr-2"></i> Tambah Klien</a>
        </div>
    </div>
</div>
<?php
...
<table id="pending" class="table table-striped table-bordered table-hover table-sm" cellspacing="0" width="100%" style="background: white;padding: 0 5px;">
    ...
    <?php foreach ($booking as $bookWedding) : ?>
        ...
        <tr>
            ...
            <td class="">
                <?= (empty($bookWedding->bride)) ?  'Perlu diisi' :  $bookWedding->bride; ?>
            </td>
            
            <td class=""><?= (empty($bookWedding->groom)) ?  'Perlu diisi' :  $bookWedding->groom; ?></td>
...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
    <h6 class="h4 mt-4 ml-3">Telah Konfirmasi</h6>
</div>
<table id="confirmed" class="table table-striped table-hover table-bordered table-sm" cellspacing="0" width="100%" style="background: white;padding: 0 5px;">
    ...
    <?php foreach ($booking_confirm as $booking_confirm_row) : ?>
        ...
        <tr>
            ...
            <td class="">
                <?= (empty($booking_confirm_row->bride)) ?  'Perlu diisi' :  $booking_confirm_row->bride; ?>
            </td>
            
            <td class=""><?= (empty($booking_confirm_row->groom)) ?  'Perlu diisi' :  $booking_confirm_row->groom; ?></td>
