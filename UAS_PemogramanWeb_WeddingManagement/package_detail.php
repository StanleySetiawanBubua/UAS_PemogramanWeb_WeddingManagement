        ...
        <div class="col-md-8 p-0" style="margin-bottom: 20px;"> <!-- border:1px solid rgba(0,0,0,.125) -->
            ...
            <div class="float-left bg-white">
                <h5 class="h5 text-uppercase mb-5 pt-3 pl-3 pr-3">
                    <span class="float-left text-capitalize"> Paket Pernikahan <?= $category->wedding_type; ?></span>
                </h5>
                ...
                <ul class="list-group">
                        <li class="list-group-item list-group-item-action bg-danger flex-column align-items-start active">
                            <div class="d-flex w-100 justify-content-between">
                                <h5 class="mb-1 pt-2 pb-2">LAYANAN DAN FUNGSI</h5>
                            </div>
                        </li>
            ...
            <div class="col-md-4" style="margin-bottom: 20px;">
                    ...
                    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" style="background: white;padding: 20px;">
                        ...
                        ?>
                         <h5 class="h5 text-center mb-3 m-0">Silahkan isi form berikut</h5>
                        ...
                        <div class="form-group">
                            <input type="number" id="user_phone" class="form-control" name="user_phone" placeholder="Nomor Telepon">
                        </div>

                        <div class="form-group">
                            <input type="email" class="form-control" name="user_email" id="user_email" placeholder="Alamat">
                        </div>
